      ...
      <section className="team-section">
        ...
        <div className="team-members">
          <div className="team-member">
            <img src="src/img/member1.jpg" alt="Membre 1" className="team-photo" />
            <h3>Jean Dupont</h3>
            <p>Fondateur et Directeur</p>
          </div>
          <div className="team-member">
            <img src="src/img/member2.jpg" alt="Membre 2" className="team-photo" />
            <h3>Marie Durand</h3>
            <p>Responsable du Développement</p>
          </div>
          <div className="team-member">
            <img src="src/img/member3.jpg" alt="Membre 3" className="team-photo" />
            <h3>Luc Martin</h3>
            <p>Designer UX/UI</p>
          </div>
        </div>
